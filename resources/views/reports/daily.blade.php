...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-4">
            {!! Form::open(array('method'=>'POST', 'id' => 'date-form')) !!}
            <div class="row">
                <div class="col-xs-9 col-sm-9 col-md-9">
                    <div class="form-group">
                        <strong>Fecha:</strong>
                        <input name="date" type="text" class="form-control datepickeR" id="daily-date" placeholder="01-01-2018">
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-lg-12" id="daily-report-table"></div>
    </div>
